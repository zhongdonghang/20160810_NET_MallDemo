...
namespace BrnMall.PayPlugin.Alipay
{
    ...
    public sealed class RSAFromPkcs8
    {
        ...
        public static bool verify(string content, string signedString, string publicKey, string input_charset)
        {
            ...
            try
            {
                Log.Debug("$$$$$标记1: ", "content (" + content + "),signedString:(" + signedString + "),publicKey(" + publicKey + "),input_charset(" + input_charset);
                ...
                Log.Debug("$$$$$标记9: ", result.ToString());
            }
            catch (Exception ex)
            {
                Log.Error("$$$$$标记9: ", ex.ToString());
            }
            return result;
        }
        ...
        private static RSAParameters ConvertFromPublicKey(string pemFileConent)
        {
            ...
            Log.Debug("标识222222222221111111111：",keyData.ToString());
