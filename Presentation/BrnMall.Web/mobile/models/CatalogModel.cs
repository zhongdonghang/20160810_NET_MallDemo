...
namespace BrnMall.Web.Mobile.Models
{
    ...
    public class ProductModel
    {
        ...
        public PageModel ReviewpageModel { get; set; }
    }

    public class AjaxReviewModel
    {
        public List<Dictionary<string, object>> ProductReviewList { get; set; }
    ...
    public class CategoryModel
    {
        ...
        /// 分页对象
        /// </summary>
        public List<CategoryInfo> ChildCateList { get; set; }
