...
namespace BrnMall.Web.StoreAdmin.Controllers
{
    ...
    public partial class ProductController : BaseStoreAdminController
    {
        ...
        public ActionResult ChangeProductIsNew(int[] pidList, int state = 0)
        {
            ...
            bool result = AdminProducts.ChangeProductIsNew(pidList, state,WorkContext.StoreId);
            if (result)
            {
        ...
        public ActionResult ChangeProductIsHot(int[] pidList, int state = 0)
        {
            ...
            bool result = AdminProducts.ChangeProductIsHot(pidList, state,WorkContext.StoreId);
            if (result)
            {
        ...
        public ActionResult ChangeProductIsBest(int[] pidList, int state = 0)
        {
            ...
            bool result = AdminProducts.ChangeProductIsBest(pidList, state,WorkContext.StoreId);
            if (result)
            {
                AddStoreAdminLog("修改商品推荐状态", "修改商品推荐状态,商品ID和状态为:" + pidList + "_" + state);
                return Content("1");
            }
            else
            {
        ...
        public ActionResult UpdateProductVipPrice(int pid = -1, decimal vipPrice = 0.00M)
        {
            ...
            if (result)
            {
                AddStoreAdminLog("修改商品本店队员价", "修改商品本店队员价,商品ID和队员价为:" + pid + "_" + vipPrice);
                return Content("1");
            }
            else
            {
