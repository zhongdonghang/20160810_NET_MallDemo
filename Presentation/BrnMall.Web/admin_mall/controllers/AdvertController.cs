...
namespace BrnMall.Web.MallAdmin.Controllers
{
    ...
    public partial class AdvertController : BaseMallAdminController
    {
        ...
        public ActionResult EditAdvert(int adId = -1)
        {
            ...
            AdvertPositionInfo posinfo = AdminAdverts.GetAdvertPositionById(advertInfo.AdPosId);

            AdvertModel model = new AdvertModel();
            model.AdPosId = advertInfo.AdPosId;
            model.AdPosDescription = posinfo==null?"":posinfo.Description;
        ...
        /// </summary>
        /// <returns></returns>
        public JsonResult GetAdvertPositionDescript(int adPosId)
        {
            var adpos = Adverts.GetAdvertPositionById(adPosId);
            if (adpos != null)
            {
                return Json(adpos.Description, JsonRequestBehavior.AllowGet);
            }
