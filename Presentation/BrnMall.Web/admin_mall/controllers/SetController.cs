...
namespace BrnMall.Web.MallAdmin.Controllers
{
    ...
    public partial class SetController : BaseMallAdminController
    {
        ...
        public ActionResult Upload()
        {
            ...
            model.UploadImgSize = mallConfigInfo.UploadImgSize / 1024/1024;
        ...
        public ActionResult Upload(UploadModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                mallConfigInfo.UploadImgSize = model.UploadImgSize * 1024*1024;
        ...
        public ActionResult Credit()
        {
            ...
            model.Point = creditConfigInfo.Point;
            model.MinAmount = creditConfigInfo.MinAmount;
            model.MinWithdrawal = creditConfigInfo.MinWithdrawal;
        ...
        public ActionResult Credit(CreditModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                creditConfigInfo.Point = model.Point;
                creditConfigInfo.MinAmount = model.MinAmount;
                creditConfigInfo.MinWithdrawal = model.MinWithdrawal;
                ...
                AddMallAdminLog("修改资金等级设置");
                return PromptView(Url.Action("credit"), "修改资金等级设置成功");
            }
            return View(model);
        }
        ...
        public ActionResult Mall()
        {
            ...
            model.OrderAutoReceive = mallConfigInfo.OrderAutoReceive;
            model.OrderAutoCancel = mallConfigInfo.OrderAutoCancel;
            return View(model);
        }
        ...
        public ActionResult Mall(MallModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                mallConfigInfo.OrderAutoReceive = model.OrderAutoReceive;
                mallConfigInfo.OrderAutoCancel = model.OrderAutoCancel;
