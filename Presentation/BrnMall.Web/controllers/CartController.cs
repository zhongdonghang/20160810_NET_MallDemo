...
namespace BrnMall.Web.Controllers
{
    ...
    public partial class CartController : BaseWebController
    {
        ...
        public ActionResult Index()
        {
            ...
            //商品合计
            decimal productAmount = Carts.SumMallCartOrderProductAmount(storeCartList, WorkContext.Uid);
            //满减折扣
        ...
        public ActionResult AddProduct()
        {
            ...
            int scSubmitType = WebHelper.GetQueryInt("scsubmittype"); //购物车的提交方式
        ...
        public ActionResult AddFullSend()
        {
            ...
            decimal amount = Carts.SumOrderProductAmount(fullSendMainOrderProductList,WorkContext.Uid);
