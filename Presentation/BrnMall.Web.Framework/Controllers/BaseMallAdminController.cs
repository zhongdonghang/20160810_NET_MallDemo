...
namespace BrnMall.Web.Framework
{
    ...
    public class BaseMallAdminController : Controller
    {
        ...
        {
            MallAdminLogs.CreateMallAdminLog(WorkContext.Uid, WorkContext.UserName, WorkContext.MallAGid, WorkContext.MallAGTitle, WorkContext.IP, operation, description);
        }
