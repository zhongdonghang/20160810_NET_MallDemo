...
namespace BrnMall.Core
{
    ...
    public class PartUserInfo
    {
        ...
        private decimal _useramount;//用户可提现金额
        private decimal _frozenamount;//用户冻结金额
        ...
        private string _wxunionids;//绑定的微信号
        ...
        {
            get { return _frozenamount; }
            set { _frozenamount = value; }
        }
        /// <summary>
        /// 等级积分
        /// </summary>
        ...
        ///绑定的微信号
        ///</summary>
        public string WxUnionIds
        {
            get { return _wxunionids; }
            set { _wxunionids = value; }
        }
    }
