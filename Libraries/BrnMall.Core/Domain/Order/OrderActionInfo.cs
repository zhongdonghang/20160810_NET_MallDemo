...
namespace BrnMall.Core
{
    ...
    /// 订单处理信息类
    /// </summary>
    public class OrderActionInfo : IComparer<OrderActionInfo>, IComparable<OrderActionInfo>  
    {
        ...
        public int Compare(OrderActionInfo oa1, OrderActionInfo oa2)
        {
            if (oa1.ActionTime > oa2.ActionTime)
            {
                return 1;
            }
            if (oa1.ActionTime < oa2.ActionTime)
        ...
        public int CompareTo(OrderActionInfo ao)
        {
            return Compare(this, ao);
        }
    }
}
