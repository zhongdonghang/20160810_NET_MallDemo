...
namespace BrnMall.Core
{
    ...
    public class PartProductInfo
    {
        ...
        private decimal _memberprice = 0M;//商品会员价
        private decimal _vipprice = 0M;//商品超级会员价
        private int _state = 0;//0代表上架，1代表下架，2代表回收站
        private int _isbest = 0;//商品是否推荐
        ...
        {
            int goodStars =Star3+ Star4 + Star5;
            int allStars = goodStars + Star1 + Star2;

            if (allStars == 0)
                return 100;
            return (int)Math.Round((decimal)goodStars * 100 / allStars,0);
        }
    }
