...
namespace BrnMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        void UpdateOnlineUserSid(int olId, string sid);
        ...
        /// <param name="ip">ip</param>
        /// <returns></returns>
        IDataReader GetOnlineGuestByIP(string ip);
        ...
        /// </summary>
        /// <param name="uid">用户id.</param>
        /// <param name="IntroduceId">推荐者Id</param>
        void CreateUserIntroduceId(int uid, int IntroduceId);
        ...
        void UpdatePayPasswordByUid(int uid, string password);
        ...
        void CreatePayPassword(int uid, string password, string salt);
        ...
        /// <param name="password">密码</param>
        /// <param name="salt">盐值</param>
        IDataReader GetUserPayPasswordByUid(int uid);
        ...
        void UpdateUserWxUnionIdsByUid(int uid, string wxnames);
        ...
        /// <param name="uid">用户id.</param>
        /// <param name="avatar">头像</param>
        void UpdateUserAvatarByUid(int uid, string avatar);
        ...
        IDataReader GetPartUserInfoByWeixinUnid(string wxunionid);
        ...
        /// <param name="storeId"></param>
        /// <returns></returns>
        DataTable GetMyIntroducerList(int uid);
        #endregion
