...
namespace BrnMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <returns></returns>
        IDataReader GetAdvertPositionsByPid(int pid);
        ...
        /// <param name="pageNumber">当前页数</param>
        /// <returns></returns>
        IDataReader GetUserAmountLogList(int uid, int pageSize, int pageNumber);

        /// <summary>
        /// 提现申请
        /// </summary>
        /// <param name="info"></param>
        void CreateWithdrawalLog(WithdrawalLogInfo info);

        /// <summary>
        /// 提现修改
        /// </summary>
        /// <param name="info"></param>
        void UpdateWithdrawalLog(WithdrawalLogInfo info);
        ...
        /// <param name="uid">用户id</param>
        /// <returns></returns>
        int GetUserAmountLogCount(int uid);
        ...
        /// <returns></returns>
        IDataReader GetWithdrawalLogById(int id);
        ...
        /// <returns></returns>
        int GetWithdrawalLogCount(int uid, int state, int paytype);
        ...
        /// <returns></returns>
        IDataReader GetWithdrawalLogList(int uid, int state, int paytype, int pagenumber, int pagesize);
        ...
        /// <param name="type">类型</param>
        /// <returns></returns>
        IDataReader GetOrderAmountLog(int oid, int type);
        ...
        /// <returns></returns>
        void CreateSMSLog(SMSLogInfo logInfo);
