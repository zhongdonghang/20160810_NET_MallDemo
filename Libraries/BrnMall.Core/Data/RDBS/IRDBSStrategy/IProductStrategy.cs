...
namespace BrnMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        bool UpdateProductVipPrice(int pid, decimal vipPrice);
        ...
        /// <returns></returns>
        IDataReader GetProductReviewReply(int prwid);

        /// <summary>
        /// 商品评价回复
        /// </summary>
        /// <param name="productReviewInfo">回复</param>
        void ProductReviewReply(ProductReviewInfo productReviewInfo);
        #endregion
