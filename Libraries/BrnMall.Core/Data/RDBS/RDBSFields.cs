...
namespace BrnMall.Core
{
    ...
    public partial class RDBSFields
    {
        ...
        /// 积分日志表
        /// </summary>
        public const string CREDITLOGS = "[logid],[uid],[useramount],[frozenamount],[rankcredits],[action],[actioncode],[actiontime],[actiondes],[operator]";

        /// <summary>
        /// 提现日志表
        /// </summary>
        public const string WITHDRAWALLOGS = "[recordid],[uid],[state],[paytype],[payaccount],[applyamount],[applyremark],[phone],[applytime],[operatoruid],[operattime],[reason]";
        ...
        /// 商品表
        /// </summary>
        public const string PRODUCTS = "[pid],[psn],[cateid],[brandid],[storeid],[storecid],[storestid],[skugid],[name],[shopprice],[marketprice],[costprice],[memberprice],[vipprice],[state],[isbest],[ishot],[isnew],[displayorder],[weight],[showimg],[salecount],[visitcount],[reviewcount],[star1],[star2],[star3],[star4],[star5],[addtime],[description]";

        /// <summary>
        /// 商品部分表
        /// </summary>
        public const string PART_PRODUCTS = "[pid],[psn],[cateid],[brandid],[storeid],[storecid],[storestid],[skugid],[name],[shopprice],[marketprice],[costprice],[memberprice],[vipprice],[state],[isbest],[ishot],[isnew],[displayorder],[weight],[showimg],[salecount],[visitcount],[reviewcount],[star1],[star2],[star3],[star4],[star5],[addtime]";
        ...
        /// 配送公司表
        /// </summary>
        public const string SHIPCOMPANIES = "[shipcoid],[name],[displayorder],[code]";
        ...
        /// 店铺配送模板表
        /// </summary>
        public const string STORE_SHIPTEMPLATES = "[storestid],[storeid],[free],[type],[title],[freeprice]";
        ...
        /// 部分用户表
        /// </summary>
        public const string PARTUSERS = "[uid],[username],[email],[mobile],[password],[userrid],[storeid],[mallagid],[nickname],[avatar],[useramount],[frozenamount],[rankcredits],[verifyemail],[verifymobile],[liftbantime],[salt]";
        ...
        /// 用户等级表
        /// </summary>
        public const string USER_RANKS = "[userrid],[system],[title],[avatar],[creditslower],[creditsupper],[limitdays],[discount]";
    }
}
