...
namespace BrnMall.Core
{
    ...
    public class MallConfigInfo : IConfigInfo
    {
        ...
        private string _mallname = "精生缘实销电子商城";//商城名称
        private string _siteurl = "http://www.cbsl888.com/";//网站网址
        private string _sitetitle = "精生缘实销电子商城";//网站标题
        private string _seokeyword = "";//seo关键字
        private string _seodescription = "";//seo描述
        private string _icp = "桂ICP22222";//备案编号
        ...
        private int _orderautoreceive = 15;//订单逾期未收货则系统自动收货（天数）
        private int _orderautocancel = 120;//订单逾期未支付则系统自动取消(分钟)
        ...
        /// 订单逾期未收货则系统自动收货（天数）
        /// </summary>
        public int OrderAutoReceive
        {
            get { return _orderautoreceive; }
            set { _orderautoreceive = value; }
        }
        /// <summary>
        /// 订单逾期未支付则系统自动取消(分钟)
        /// </summary>
        public int OrderAutoCancel
        {
            get { return _orderautocancel; }
            set { _orderautocancel = value; }
        }
        #endregion
    }
}
