    ...
    public partial class OnlineUsers
    {
        ...
        public static void UpdateOnlineUser(object state)
        {
            lock (_locker)
            {
                ...
                {
                    var guest = GetOnlineGuestByIP(updateOnlineUserState.IP);
                    if (guest != null)
                    {
                        onlineUserInfo = guest;
                    }
                }
                if (onlineUserInfo != null)
                {
                    if (onlineUserInfo.Sid != updateOnlineUserState.Sid)
                    {
                        UpdateOnlineUserSid(onlineUserInfo.OlId, updateOnlineUserState.Sid);
                    }
        ...
        /// <param name="ip">sid</param>
        public static void UpdateOnlineUserSid(int olId, string sid)
        {
            BrnMall.Data.OnlineUsers.UpdateOnlineUserSid(olId, sid);
        }
        ...
        /// <param name="ip">ip</param>
        /// <returns></returns>
        public static OnlineUserInfo GetOnlineGuestByIP(string ip)
        {
            return BrnMall.Data.OnlineUsers.GetOnlineGuestByIP(ip);
        }
