...
namespace BrnMall.Services
{
    ...
    public partial class MallAdminGroups
    {
        ...
        private static void WriteMallAdminNavMenuCache(MallAdminGroupInfo mallAdminGroupInfo)
        {
            ...
            if (mallAdminGroupActionHashSet.Contains("userupgrade"))
            {
                menu.AppendFormat("{0}\"title\":\"会员升级\",\"url\":\"/malladmin/userrank/userupgrade\"{1},", "{", "}");
                flag = true;
            }
            ...
            if (mallAdminGroupActionHashSet.Contains("userloadcash"))
            {
                menu.AppendFormat("{0}\"title\":\"会员充值\",\"url\":\"/malladmin/user/usercashlist\"{1},", "{", "}");
                flag = true;
            }
            if (flag)
            {
            ...
            flag = false;
            menu = menu.Clear();
            menu.AppendFormat("{0}\"title\":\"品牌分类\",\"subMenuList\":[", "{");
            ...
            flag = false;
            menu = menu.Clear();
            menu.AppendFormat("{0}\"title\":\"资金管理\",\"subMenuList\":[", "{");
            if (mallAdminGroupActionHashSet.Contains("amount"))
            {
                menu.AppendFormat("{0}\"title\":\"提现申请\",\"url\":\"/malladmin/amount/withdrawllist\"{1},", "{", "}");
                flag = true;
            }
            if (flag)
            {
            ...
            if (mallAdminGroupActionHashSet.Contains("set"))
            {
                ...
                menu.AppendFormat("{0}\"title\":\"资金等级\",\"url\":\"/malladmin/set/credit\"{1},", "{", "}");
