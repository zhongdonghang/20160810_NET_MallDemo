...
namespace BrnMall.Services
{
    ...
    public partial class Categories
    {
        ...
        {
            return BrnMall.Data.Categories.GetCategoryBrandList(cateId); ;
        }
        ...
        /// <returns></returns>
        public static List<CategoryInfo> GetCategoryListByLayer(int layer)
        {
            List<CategoryInfo> layList = new List<CategoryInfo>();
