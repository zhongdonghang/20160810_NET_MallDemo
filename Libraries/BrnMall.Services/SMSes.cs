...
namespace BrnMall.Services
{
    ...
    public partial class SMSes
    {
        ...
        /// </summary>
        /// <param name="to">接收手机</param>
        /// <param name="code">发送内容</param>
        /// <returns></returns>
        public static bool SendSCVerifySMS(string to, string content)
        {
            return _ismsstrategy.Send(to, content);
        }
        ...
        {
             BrnMall.Data.SMSes.CreateSMSLog(logInfo);
        }
    }
}
