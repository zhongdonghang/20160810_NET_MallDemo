...
namespace BrnMall.Data
{
    ...
    public partial class Products
    {
        ...
        public static ProductInfo BuildProductFromReader(IDataReader reader)
        {
            ...
            productInfo.MemberPrice = TypeHelper.ObjectToDecimal(reader["memberprice"]);
            productInfo.VipPrice = TypeHelper.ObjectToDecimal(reader["vipprice"]);
        ...
        public static PartProductInfo BuildPartProductFromReader(IDataReader reader)
        {
            ...
            partProductInfo.MemberPrice = TypeHelper.ObjectToDecimal(reader["memberprice"]);
            partProductInfo.VipPrice = TypeHelper.ObjectToDecimal(reader["vipprice"]);
        ...
        public static StoreProductInfo BuildStoreProductFromReader(IDataReader reader)
        {
            ...
            storeProductInfo.CostPrice = TypeHelper.ObjectToDecimal(reader["memberprice"]);
            storeProductInfo.CostPrice = TypeHelper.ObjectToDecimal(reader["vipprice"]);
        ...
        /// </summary>
        /// <param name="pid">商品id</param>
        /// <param name="shopPrice">队员价</param>
        public static bool UpdateProductVipPrice(int pid, decimal vipPrice)
        {
            bool result = BrnMall.Core.BMAData.RDBS.UpdateProductVipPrice(pid, vipPrice);
            if (_productnosql != null)
                _productnosql.UpdateProductVipPrice(pid, vipPrice);
            return result;
        }
        ...
        /// <param name="storeId">店铺id</param>
        /// <param name="storeCid">店铺分类id</param>
        /// <param name="trait">特征(0代表推荐,1代表热销,2代表新品)</param>
        /// <returns></returns>
