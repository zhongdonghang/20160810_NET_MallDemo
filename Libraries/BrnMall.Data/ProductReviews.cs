...
namespace BrnMall.Data
{
    ...
    public partial class ProductReviews
    {
        ...
        /// <returns></returns>
        public static ProductReviewInfo GetProductReviewReply(int prwid)
        {
            ProductReviewInfo productReviewinfo = null;
            IDataReader reader = BrnMall.Core.BMAData.RDBS.GetProductReviewReply(prwid);
            while (reader.Read())
            {
                productReviewinfo = BuildProductReviewFromReader(reader);
                break;
        ...
        /// 商品评价回复
        /// </summary>
        /// <param name="productReviewInfo">回复</param>
        /// <returns></returns>
        public static void ProductReviewReply(ProductReviewInfo productReviewInfo)
        {
            BrnMall.Core.BMAData.RDBS.ProductReviewReply(productReviewInfo);
        }
    }
}
