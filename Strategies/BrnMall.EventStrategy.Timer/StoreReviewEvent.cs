    ...
    public class StoreReviewEvent : IEvent
    {
        ...
        public void Execute(object eventInfo)
        {
            ...
            foreach (DataRow storeIdRow in storeIdList.Rows)
            {
                ...
                DataTable storeReview = Stores.SumStoreReview(storeId, null, null);
                ...
                {
                    dePoint = (descriptionStar1 + descriptionStar2 * 2 + descriptionStar3 * 3 + descriptionStar4 * 4 + descriptionStar5 * 5) * 2 / totalDescriptionStar;
                }
                ...
                {
                    sePoint = (serviceStar1 + serviceStar2 * 2 + serviceStar3 * 3 + serviceStar4 * 4 + serviceStar5 * 5) * 2 / totalServiceStar;
                }
                ...
                if (totalShipStar != 0)
                {
                    shPoint = (shipStar1 + shipStar2 * 2 + shipStar3 * 3 + shipStar4 * 4 + shipStar5 * 5) * 2 / totalShipStar;
                }
